...
The fixed-model numeric state, removal and imputation ablations for amount,
...
The leakage-safe history and identity rules that selectively recover
`functional needs repair` decisions from the final ensemble are in
[`repair-rule-ensemble-screen.md`](repair-rule-ensemble-screen.md).
...
Keep short, evidence-led write-ups here:

- validation design and baseline;
- model comparison;
- error analysis and interpretation;
- final result and practical implications.
